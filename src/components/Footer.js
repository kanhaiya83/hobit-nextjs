    ...
    <footer className="w-full bg-slate-100 text-slate-800 py-10 px-[5%] md:px-[10%]">
      ...
      <div className="grid grid-cols-2 gap-y-2 md:grid-cols-3 w-full mb-6">
        <div className="flex flex-col">
          ...
          <a href="#" className="text-sm mb-2">About Us</a>
        ...
        <div className="flex flex-col">
          ...
          <a href="#" className="text-sm mb-2">Cookies Policy</a>
          <a href="#" className="text-sm mb-2">Privacy Policy</a>
          <a href="#" className="text-sm mb-2">Terms of Services</a>
          <a href="#" className="text-sm mb-2">Law Enforcement</a>
        </div>
